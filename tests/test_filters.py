...
from utils.filters import filter_by_currency, filter_by_status, sort_by_date
...
class TestFilters:
    ...
    def sample_data(self):
        return [
            {"date": "2023-01-01T12:00:00Z", "state": "EXECUTED", "operationAmount": {"currency": {"code": "RUB"}}},
            {"date": "2023-01-02T12:00:00Z", "state": "CANCELED", "operationAmount": {"currency": {"code": "USD"}}},
            {"date": "2023-01-03T12:00:00Z", "state": "EXECUTED", "operationAmount": {"currency": {"code": "EUR"}}},
        ]
